...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {/* Slide-in Menu */}
      <div
        className={`fixed inset-0 z-30 bg-gray-800 bg-opacity-20 transition-opacity duration-300 ${
          menuOpen ? "opacity-100" : "opacity-0 pointer-events-none"
        }`}
        onClick={() => setMenuOpen(false)}
      />
      <div
        className={`fixed top-0 left-0 bg-white z-50 h-full w-2/3 md:w-1/2 transition-transform duration-300 transform ${
